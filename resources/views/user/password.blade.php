...
@section('user-content')
    <form class="form-horizontal" method="post" action="{{ route('user:password:handle') }}">
        ...
        <div class="form-group">
            <label for="editor-project-name" class="col-sm-2 control-label">@lang('passwords.original_password')</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label for="editor-project-name" class="col-sm-2 control-label">@lang('passwords.new_password')</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label for="editor-project-name" class="col-sm-2 control-label">@lang('passwords.new_password_confirm')</label>
            <div class="col-sm-10">
                <input type="password" class="form-control"
